...
class RestoreAccount extends UseCase<AuthSession, RestoreAccountParams> {
  const RestoreAccount(this._repository);

  final AuthenticationRepository _repository;

  @override
  ResultFuture<AuthSession> call(RestoreAccountParams params) =>
      _repository.restoreAccount(
